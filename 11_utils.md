...
В поставку инструмента входит скрипт `guest_system/debuginfo_collector/debug_info.py`,
...
### <a name="symbol_info"></a>11.3.3. symbol_info

*symbol_info.py* - парсит символьную информацию в исполняемых файлах и записывает её в подкаталог vmidb. Его нужно запускать после обновления Natch или добавления новых файлов в конфиг module.cfg.
