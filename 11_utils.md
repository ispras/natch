...
то можно включить данную директорию в скрипт, используя опцию, указанную ниже. По умолчанию, данную директорию обычно можно найти по следующему пути: `/usr/lib/debug`.
