...
В редких случаях может потребоваться ручная доработка, подробная формация про этот файл в [Приложение 3. Формат списка исполняемых модулей](9_appendix.md#module_config)
(--ССЫЛКА--)
