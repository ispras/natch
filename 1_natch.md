...
* написать 7 раздел про запись-воспроизведение
* привести в порядок 10 раздел про автоматизацию
* прочитать квик старт (не нравится автоматизированная настройка)
* довести до ума раздел про утилиты
* релиз ноутс
* проверить на актуальность фак
