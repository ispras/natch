...
примеры использования --- в разделе [Начало работы](2_quickstart.md),
анализ и оценка результатов в *SNatch* --- в разделе [Анализ поверхности атаки с помощью SNatch](6_snatch.md).
