...
Выполнить запись трассы согласно [пункта](#record_scenario), на этапе с созданием снапшота, необходимо на хостовой машине открыть новое окно терминала и выполнить подключение к тестовой ОС:
```
nc -N 0.0.0.0 7799
```
...
Воспроизвести трассу, согласно [пункта](#replay_scenario)
Запустить snatch, согласно [пункта](#snatch_analysis)
