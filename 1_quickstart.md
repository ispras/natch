...
## ВНИМАНИЕ! На момент 08.05.2023 по прежнему наблюдается проблема с тем, что VirtualBox версии 7+ (7.0.8) не позволяет корректно запускать qemu в режиме поддержки kvm. Используйте VirtualBox версии 6. Наиболее актуальный тикет на данную ошибку заведён [здесь](https://www.virtualbox.org/ticket/21552), пока что без ответа.
