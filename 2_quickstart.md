...
Рекомендации по подготовке хостовой системы приведены [здесь](https://gitlab.ispras.ru/natch/natch-support/-/wikis/Natch%20requirements) (*для получения доступа к репозиторию сообщества ознакомьтесь с информацией в описании телеграм-канала [Орг. вопросы::Доверенная разработка](https://t.me/sdl_community)*).
...
### 2.3.2. Анализ образа системы в режиме командной строки в контейнере с файлом - источником помеченных данных
...
#### 2.3.2.1. Подготовка образа виртуальной машины
...
#### 2.3.2.2. Сборка программы обработчика
...
#### 2.3.2.3. Перенос объекта оценки
...
#### 2.3.2.4. Создание контейнера и запуск Natch
