...
## <a name="taint_config"></a>3.2. Конфигурационный файл для помеченных данных
...
## <a name="api_config"></a>3.3. Конфигурационный файл для модулей
...
## <a name="tasks_config"></a>3.4. Конфигурационный файл для процессов
...
## <a name="syscalls_config"></a>3.5. Конфигурационный файл для системных вызовов
