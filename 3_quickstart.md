...
Работа с *Natch* предполагает подготовку образа операционной системы для QEMU. В первой части этого раздела описаны все подготовительные действия, которые могут потребоваться перед работой непосредственно с инструментом.

Во второй части раздела представлен пошаговый разбор работы с *Natch*, а так же немного затронут инструмент *SNatch* (немного, потому что про него есть [отдельный раздел](6_snatch.md#snatch)).
...
!!!!!!!!! Переехало в установку и настройку Natch.
