...
После загрузки архива в *SNatch* откроется вкладка с графом процессов. Если выделить мышкой интересующий вас процесс, появится боковая панель
с дополнительной информацией. Боковая панель присуща большинству аналитик. Выглядит это следующим образом:
