...
**Важно!** Для ознакомления с *Natch* можно сразу переходить ко второй части, все тестовые материалы подготовлены разработчиком.
...
Отредактируем основной конфигурационный файл *Natch* `natch.cfg` в соответствии с рекомендациями. _Не забываем, что необходимо раскомментировать также названия секций в квадратных скобках, а не только сами параметры._.
Раскомментируем следующую секцию (подробнее об предназначении секций см. пункт [Основной конфигурационный файл](4_configs.md#main_config) документации):
