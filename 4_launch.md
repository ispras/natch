...
- *symbol_info.py* - парсит символьную информацию, формирует базу символов для дальнейшнего анализа в графической подсистеме SNatch. Так же требуется *module.cfg*
...
## 4.4. Определение источников пометки
## 4.4.1 Пометка файлов
...
## 4.4.2 Пометка входящих сетевых пакетов
