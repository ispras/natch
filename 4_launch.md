...
# 4. Запуск Natch <a name="natch_run_main">
...
## 4.1. Использование скрипта для генерации командных строк запуска <a name="natch_run_script"></a>
...
- *config*
Задает файл конфигурации инструмента (подробнее в [разделе](3_configs.md#main_config)).
