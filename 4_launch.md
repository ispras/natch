...
Предварительно следует установить *Natch* (подробнее в разделе [Комплект поставки Natch](1_quickstart.md#complect)).
...
Задать необходимые для пометки файлы можно в [конфигурационном файле для помеченных данных](3_configs.md#taint_config).
