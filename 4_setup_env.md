...
# <a name="setup_env"></a>4. Настройка окружения для работы с Natch
...
## <a name="create-qemu-env"></a>4.1. Подготовка виртуализованной среды в формате QEMU
...
Требования к хостовой системе приведены в разделе [Приложение 7. Требования и ограничения Natch](20_app_requirements.md#app_requirements).
...
### <a name="build_prototype"></a>4.1.2. Сборка прототипа объекта оценки

Рекомендации по подготовке исполняемого кода приведены в разделе [Приложение 8. Рекомендации по подготовке объекта оценки](21_app_oo_preparation.md#app_preparation).
...
(подробнее в разделе [Копирование файлов из гостевой системы](11_utils.md#copy_files)):
