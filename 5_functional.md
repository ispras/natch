...
# 5. Функциональные возможности Natch <a name="natch_functional"></a>
...
## 5.2. Подробная трасса помеченных данных <a name="taint_log"></a>
...
## 5.3. Получение областей помеченной памяти для функций <a name="taint_params_log"></a>
...
## 5.7. Анализ покрытия бинарного кода <a name="functional_coverage"></a>
