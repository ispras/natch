...
В режиме воспроизведения существует возможность логирования обработанных сетевых пакетов. Для этого в основной конфигурационный файл *Natch* необходимо добавить секцию *NetLog* (пример приведен в пункте [Дополнительная ручная настройка](1_quickstart.md#additional_settings)).
