...
Далее скрипт попросит ввести пароль администратора. Далее будет происходить монтирование образа, удостоверьтесь, что в системе не работают другие виртуальные машины.
После чего все действия будут происходить автоматически и могут занять продолжительное время.
