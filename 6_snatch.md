...
### 6.3.2. Граф процессов {#process_graph}
...
### 6.3.3. Граф модулей {#module_graph}
...
#### 6.3.4.2 Граф вызовов python {#python_call_graph}
...
### 6.3.7. Дерево процессов {#process_tree}
...
### 6.3.8. Список ресурсов {#resources}
