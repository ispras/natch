...
API реализовано бэкэндом SNatch, поэтому чтобы им пользоваться, необходимо запустить скрипт snatch_run, как и при браузерном использовании.

### 6.6.1. ci_create_project
