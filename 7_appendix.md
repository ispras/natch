...
# <a name="module_config"></a>Приложение 3. Формат списка исполняемых модулей (module_config.cfg) <a name="module_config"></a> {-}
...
# <a name="natch_mon_commands"></a>Приложение 5. Команды монитора Qemu для работы с Natch <a name="natch_mon_commands"></a> {-}
