...
# <a name="app_6"></a>Приложение 6. Генерация map-файлов в случае, когда возможность сборки исполняемого файла из исходных текстов с произвольными параметрами отсутствует, либо явно требуется получение отдельных [map-файлов](https://stackoverflow.com/questions/22199844/what-are-gcc-linker-map-files-used-for).**

### *Генерация map-файлов средствами компилятора*
...
### *Генерация map-файлов сторонними инструментами*
...
# <a name="app_6"></a>Приложение 7. История релизов Natch
