...
<a name="natch_light"></a>

## Облегченный режим работы Natch
...
## Подробная трасса помеченных данных
...
<a name="taint_params_log"></a>

## Получение областей помеченной памяти для функций
...
<a name="functional_coverage"></a>

## Анализ покрытия бинарного кода
...
### Анализ покрытия бинарного кода с помощью IDA Pro
...
### Конвертация покрытия cov64 в lcov
...
## Получение аргументов вызываемых функций
...
для этого в секции *[Mode]* конфигурационного файла сценария параметр *light* следует установить в *true*, таким образом,
