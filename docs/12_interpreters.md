...
# <a name="natch_interpreters"></a>12. Использование Natch для интерпретируемых языков
...
## <a name="interpreters_python"></a>12.1. Анализ Python приложений
...
## <a name="interpreters_java"></a>12.2. Анализ Java приложений
