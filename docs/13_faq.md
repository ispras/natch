...
См. [natch tuning](#cmd_tuning). В случае проблем с тюнингом вашей гостевой ОС, обратитесь в техническую поддержку.
...
Подробнее в разделе [Интерактивный режим создания проекта](#natch_run_script).
Также несколько типичных случаев редактирования командной строки описаны в приложении
[Изменение командной строки эмулятора](#natch_cmd_line).
