...
==========================================
```
[Конфигурирование БД на Alt и РЕД ОС](2_setup.md#snatchconfigure)
...
# <a name="snatchconfigure"></a> **Настройка и запуск для Alt и РЕД ОС**
...
==========================================
 ...
 Password: zc03c03OwmEN80dHY
==========================================
To use ISP RAS SNatch start /usr/bin/snatch/run.sh
```

Запустите *run.sh*. Это потребует прав суперпользователя для запуска зависимых служб. По завершении вы увидите сообщение:
```
