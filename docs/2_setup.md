...
### <a name="setup_astra"></a>2.2.3. Настройка ОС Astra Linux для работы с Natch
...
Astra Linux версии 1.7: *Пуск -> Панель управления -> Безопасность -> Политика безопасности ->
Настройка безопасности -> Системные параметры -> Снять галочку с "Блокировать трассировку ptrace для всех пользователей"*.

Astra Linux версии 1.8: *Пуск -> Параметры -> Параметры системы -> Безопасность -> Монитор безопасности ->
Пройти аутентификацию -> Выделить "Блокировка трассировки ptrace" -> Нажать кнопку "Настроить "Блокировка трассировки ptrace"" -> Снять галочку с "Блокировка трассировки ptrace для всех пользователей, включая администраторов" -> Нажать кнопку "Применить" -> Перезагрузить операционную систему*.
