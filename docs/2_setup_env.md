...
При создании виртульной машины следует выделить максимально допустимое для вас количество оперативной памяти,
...
После установки ОС, систему необходимо выключить и донастроить в интрерфейсе VirtualBox.
...
образа с вашим программным продуктом](6_prepare_image.md#prepare_image).
