...
-- дополнение проекта новыми модулями
...
обновление текущих модулей в проекте
...
извлечение файлов из образа в хостовую систему
...
загрузка в образ файлов из хостовой системы
