...
`natch_run.py`, с помощью которого создаются проекты.
...
с помощью специального скрипта `natch_run.py` или конфигурационного файла. Ниже представлено описание каждого способа.
