...
Требования к хостовой системе приведены в разделе [Требования и ограничения Natch](#app_requirements).
...
Рекомендации по подготовке исполняемого кода приведены в разделе [Рекомендации по подготовке и анализу объекта оценки](#app_preparation).
...
(подробнее в разделе [Командный интерфейс Natch](#cmd_modules_extract)):
