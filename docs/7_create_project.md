...
* [Командный интерфейс для работы с инструментом](5_natch_cmd.md#natch_cmd)
...
[Запись и воспроизведение сценариев](9_scenario_work.md#record_replay)), а так же главный конфигурационный файл `natch.cfg`,
...
- `-c/--config` -- путь к конфигурационному файлу, с помощью которого можно автоматически
  ...
  [Создание проекта с помощью конфигурационного файла](7_create_project.md#natch_save_settings))
...
<a name="natch_save_settings"></a>

## Создание проекта с помощью конфигурационного файла
