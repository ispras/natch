...
Чтобы можно было увидеть исходные коды исследуемого ПО, потребуется выполнить команду [`natch coverage extract`](3_natch_cmd.md#cmd_coverage),
...
#### 9.4.6.2. Граф вызовов интерпретаторов
...
### 9.5.2. Управление интерактивными элементами вкладок
...
## 9.6. Изменение каталога для хранимых проектов
