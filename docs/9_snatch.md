...
Главное меню предоставляет доступ к созданию нового сценария, настройкам, экспорту открытого сценария в .pdf и информации о сценарии.
Можно закрыть текущий сценарий, тогда будет осуществлен переход ко вкладке "список сценариев"
...
На данной вкладке отображаются древовидные структуры с процессом в корне, где для каждого процесса отображается ранжированный список ресурсов
