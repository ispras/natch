...
### <a name="info_block"></a>9.4.2. Информационный блок
...
### <a name="process_tree"></a>9.4.9. Дерево процессов
...
## <a name="changedatadir"></a> 9.6. Изменение каталога для хранимых проектов
