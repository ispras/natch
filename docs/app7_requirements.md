...
* Хостовая ОС должна быть семейства Linux, официальные сборки делаются для Alt 10/11, Astra Linux 1.7/1.8, Debian 12/13, Ubuntu 22/24, РЕД ОС 8.
...
* Гостевая ОС должна быть семейства Linux, в частности, поддерживается работа в Alt 10/11, Astra Linux 1.7/1.8, Debian 12/13, Fedora 36-44, Ubuntu 22-26, РЕД ОС 8. Также поддерживаются FreeBSD, Microsoft Windows 8/8.1/10/11.
