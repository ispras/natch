...
<a name="create-qemu-env"></a>

## Подготовка виртуализованной среды в формате QEMU
...
Требования к хостовой системе приведены в разделе [Требования и ограничения Natch](app7_requirements.md#app_requirements).
...
Рекомендации по подготовке исполняемого кода приведены в разделе [Рекомендации по подготовке и анализу объекта оценки](app8_oo_preparation.md#app_preparation).
...
(подробнее в разделе [Командный интерфейс Natch](3_natch_cmd.md#cmd_modules_extract)):
