...
подготовка образа исследуемой системы -- в разделе [Настройка окружения для работы с Natch](5_setup_env.md#setup_env),
описание команд для работы с инструментом -- в разделе [Командный интерфейс Natch](3_natch_cmd.md#natch_cmd),
запись и воспроизведение сценариев работы с исследуемым ПО -- в разделе [Запись и воспроизведение сценариев](8_scenario_work.md#record_replay),
описание источников пометки -- в разделе [Определение источников пометки](7_taint_source.md#taint_source),
анализ и оценка результатов в *SNatch* -- в разделе [Анализ поверхности атаки с помощью SNatch](9_snatch.md#snatch).
...
Рекомендации по подготовке объекта оценки приведены в разделе [Рекомендации по подготовке и анализу объекта оценки](app8_oo_preparation.md#app_preparation).
